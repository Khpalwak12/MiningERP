...
export default function Edit({ payment, customers }) {
    ...
    return (
        <ErpLayout>
            ...
            <FlashMessage />
            <h1 className="mb-6 text-2xl font-bold">{t('payments.edit')}</h1>

            <form onSubmit={(e) => { e.preventDefault(); put(route('payments.update', p.id)); }} className="max-w-2xl space-y-4 rounded-lg bg-white p-6 shadow">
                <div>
