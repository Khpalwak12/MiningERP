...
export default function Edit({ mineType }) {
    ...
    return (
        <ErpLayout>
            ...
            <FlashMessage />
            <h1 className="mb-2 text-2xl font-bold">{t('mine_types.edit')}</h1>
            <ShipmentsNav active="mine-types.index" />

            <form onSubmit={(e) => { e.preventDefault(); put(route('mine-types.update', m.id)); }} className="max-w-2xl space-y-4 rounded-lg bg-white p-6 shadow">
                <div>
