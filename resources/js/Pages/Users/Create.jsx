...
export default function Create({ roles }) {
    ...
    return (
        <ErpLayout>
            ...
            <FlashMessage />
            <h1 className="mb-6 text-2xl font-bold">{t('users.create')}</h1>

            <form onSubmit={(e) => { e.preventDefault(); post(route('users.store')); }} className="max-w-2xl space-y-4 rounded-lg bg-white p-6 shadow">
