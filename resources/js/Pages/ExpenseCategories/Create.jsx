...
export default function Create() {
    ...
    return (
        <ErpLayout>
            ...
            <FlashMessage />
            <h1 className="mb-2 text-2xl font-bold">{t('expense_categories.create')}</h1>
            <ExpensesNav active="expense-categories.index" />

            <form onSubmit={(e) => { e.preventDefault(); post(route('expense-categories.store')); }} className="max-w-2xl space-y-4 rounded-lg bg-white p-6 shadow">
                <div>
